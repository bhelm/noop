...
///
/// The file is GENERATED by a standalone Swift run
/// (`openspec/changes/frame-integrity/oracle-gen`) — never hand-written, so no expected value here is
/// somebody's belief about what the verifier does. Regenerate it rather than editing it.
///
