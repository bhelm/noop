...
- [x] The frame-integrity verdict is pinned by a **shared oracle**, not by reading the two
      ...
      `android/app/src/test/resources/`), is generated by a standalone Swift run, and lists per
      frame the verdict, the reject reason **and** the historical-metadata classification.
